...
args = {
    "project_id": "rom-cylinder-0521182921",
}

dag = DAG(
    "rom-cylinder-0521182921",
    default_args=args,
...
cos_bucket = "rom-data"
cos_directory = "rom-cylinder-0521182921"
cos_dependencies_archive = "0_fetch_data-6014d4a5-f553-44a8-abfa-dae58417a28c.tar.gz"
notebook_file = "work/0_fetch_data.ipynb"

# Download dependencies
print(f"Downloading dependencies from {cos_endpoint}/{cos_bucket}/{cos_directory}/{cos_dependencies_archive}")
...
subprocess.run(["papermill", notebook_file, notebook_file, 
                "-p", "cos-endpoint", cos_endpoint, 
                "-p", "cos-bucket", cos_bucket, 
                "-p", "cos-directory", cos_directory, 
                "-p", "cos-dependencies-archive", cos_dependencies_archive], 
               check=True)
EOF
...
cos_bucket = "rom-data"
cos_directory = "rom-cylinder-0521182921"
cos_dependencies_archive = "1_preprocess_data-f029183f-8c3e-458f-aeea-79bfd8c119b0.tar.gz"
notebook_file = "work/1_preprocess_data.ipynb"
...
cos_bucket = "rom-data"
cos_directory = "rom-cylinder-0521182921"
cos_dependencies_archive = "2_rom_modeling-4a25aef9-e4dd-4b4a-b281-5ff2a04ad00a.tar.gz"
notebook_file = "work/2_rom_modeling.ipynb"
...
cos_bucket = "rom-data"
cos_directory = "rom-cylinder-0521182921"
cos_dependencies_archive = "3_visuazalition-501534df-7597-4371-b989-e422c7eec230.tar.gz"
notebook_file = "work/3_visuazalition.ipynb"
