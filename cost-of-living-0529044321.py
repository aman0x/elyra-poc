...
args = {
    "project_id": "cost-of-living-0529044321",
}

dag = DAG(
    dag_id="cost-of-living-0529044321",
    default_args=args,
    schedule="@once",
...
op_376b926c_bd5b_4075_ba81_4582be13ab4f = KubernetesPodOperator(
    name="VISUALIZATION",
    namespace="airflow-elyra",
    image="continuumio/anaconda3:2024.10-1",
    cmds=["sh", "-c"],
    arguments=[
        "mkdir -p ./jupyter-work-dir/ && cd ./jupyter-work-dir/ && echo 'Downloading https://raw.githubusercontent.com/elyra-ai/elyra/main/elyra/airflow/bootstrapper.py' && curl --fail -H 'Cache-Control: no-cache' -L https://raw.githubusercontent.com/elyra-ai/elyra/main/elyra/airflow/bootstrapper.py --output bootstrapper.py && echo 'Downloading https://raw.githubusercontent.com/elyra-ai/elyra/main/etc/generic/requirements-elyra.txt' && curl --fail -H 'Cache-Control: no-cache' -L https://raw.githubusercontent.com/elyra-ai/elyra/main/etc/generic/requirements-elyra.txt --output requirements-elyra.txt && python3 -m pip install packaging && python3 -m pip freeze > requirements-current.txt && python3 bootstrapper.py --pipeline-name 'cost-of-living' --cos-endpoint http://minio.minio-system.svc.cluster.local:9000 --cos-bucket customer-bucket --cos-directory 'cost-of-living-0529044321' --cos-dependencies-archive 'cost_data_visualizer-376b926c-bd5b-4075-ba81-4582be13ab4f.tar.gz' --file 'cost_data_visualizer.py' "
    ],
...
op_376b926c_bd5b_4075_ba81_4582be13ab4f << op_6daad1ae_2355_4224_aea7_7c94f2c0ef1d
