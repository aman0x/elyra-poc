...
args = {
    "project_id": "cost-of-living-0523105826",
}

dag = DAG(
    "cost-of-living-0523105826",
    default_args=args,
...
# Operator source: work/COST OF LIVING/cost_data_fetcher.py
...
# Operator source: work/COST OF LIVING/cost_data_visualizer.py
...
op_53136309_0b4b_496d_ab5c_4abf6c8c0264 = KubernetesPodOperator(
    ...
    cmds=["sh", "-c"],
    arguments=[
        "mkdir -p ./jupyter-work-dir/ && cd ./jupyter-work-dir/ && echo 'Downloading https://raw.githubusercontent.com/elyra-ai/elyra/v3.15.0/elyra/airflow/bootstrapper.py' && curl --fail -H 'Cache-Control: no-cache' -L https://raw.githubusercontent.com/elyra-ai/elyra/v3.15.0/elyra/airflow/bootstrapper.py --output bootstrapper.py && echo 'Downloading https://raw.githubusercontent.com/elyra-ai/elyra/v3.15.0/etc/generic/requirements-elyra.txt' && curl --fail -H 'Cache-Control: no-cache' -L https://raw.githubusercontent.com/elyra-ai/elyra/v3.15.0/etc/generic/requirements-elyra.txt --output requirements-elyra.txt && python3 -m pip install packaging && python3 -m pip freeze > requirements-current.txt && python3 bootstrapper.py --pipeline-name 'cost-of-living' --cos-endpoint http://minio.minio-system.svc.cluster.local:9000 --cos-bucket rom-data --cos-directory 'cost-of-living-0523105826' --cos-dependencies-archive 'cost_data_visualizer-53136309-0b4b-496d-ab5c-4abf6c8c0264.tar.gz' --file 'work/COST OF LIVING/cost_data_visualizer.py' "
    ],
